...
for s = 1, screen.count() do
    --tags[s] = awful.tag({ "1 ", "2 ", "3 ", "4 ", "5 ", "6" }, s,
     tags[s] = awful.tag({ "web", "term", "code", "files", "docs", "media" }, s,
  		       { layouts[1], layouts[2], layouts[4],
 			  layouts[1], layouts[4], layouts[1]
 		       })
...
awful.key({ modkey }, "z", function ()
    ...
    awful.key({ altkey,		  }, "e",     function () awful.util.spawn(manager) end),
    awful.key({ altkey,		  }, "f",      function () awful.util.spawn(cli_fileman) end),
    awful.key({ altkey,		  }, "w",     function () awful.util.spawn(browser) end),
    ...
    --  Monitor focus
    -- 1 = DVI-I-2, right primary
    -- 2 = DVI-I-3, left secondary
