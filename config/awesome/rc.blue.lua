...
tags = {
       ...
       layout = { layouts[2], layouts[3], layouts[2], layouts[4] }
       }
for s = 1, screen.count() do
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey ,"Shift" }               , "Return" , function () awful.util.spawn(terminal_no_tmux) end)       ,
    ...
    -- Dropdown terminal
    awful.key({ altkey,	          }, "`",      function () scratch.drop(terminal_no_tmux) end),
