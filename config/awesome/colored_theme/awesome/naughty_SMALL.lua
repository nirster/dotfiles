...
function naughty.notify(args)
    ...
    local fg = args.fg or preset.fg or beautiful.fg_normal or '#ffaf5f'
    local bg = args.bg or preset.bg or beautiful.bg_normal or '#080808'
    local border_color = args.border_color or preset.border_color or beautiful.bg_focus or '#404040'
