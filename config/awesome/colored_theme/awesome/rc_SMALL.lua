...
globalkeys = awful.util.table.join(
    ...
    key({ altkey },             "n",                function () exec( "sudo dmenu_run -b -nb '#080808' -nf '#aaaaaa' -sf '#ce5666' -sb '#080808' -fn '*-tamsyn-medium-r-normal-*-14-*-*-*-*-*-*-*' -f -h 20 -p 'run application (root):'", false) end),
    key({ altkey },             "c",                function () exec( "dnetcfg -b -nb '#080808' -nf '#aaaaaa' -sf '#ffaf5f' -sb '#080808' -fn '-*-tamsyn-medium-r-normal-*-14-*-*-*-*-*-*-*' -f -h 20", false) end),
    -- key({ altkey },             "q",                function () exec( "dpm -b -nb '#080808' -nf '#aaaaaa' -sf '#87af5f' -sb '#080808' -fn '-*-tamsyn-medium-r-normal-*-14-*-*-*-*-*-*-*' -f -h 20", false) end),
