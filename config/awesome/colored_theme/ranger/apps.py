...
CustomApplications.generic(
	'firefox', 'midori', 'zathura', 'llpp', 'gimp',
	'libreoffice', 'vlc', 'mplayer', 'geany', 'viewnior',
			flags='d', deps=['X'])
